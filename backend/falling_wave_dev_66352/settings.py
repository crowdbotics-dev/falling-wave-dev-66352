"""
Django settings for falling_wave_dev_66352 project.
...
ROOT_URLCONF = 'falling_wave_dev_66352.urls'
...
WSGI_APPLICATION = 'falling_wave_dev_66352.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "falling_wave_dev_66352 API",
    "DESCRIPTION": "API documentation for falling_wave_dev_66352 App",
    "VERSION": "v1",
}
